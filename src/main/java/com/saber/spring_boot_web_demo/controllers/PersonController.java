...
public class PersonController {
    ...
    @Operation(summary = "findAll", description = "findAll", method = "get", tags = "findAll person service")
    @ApiResponses(value = {
    ...
    @Operation(summary = "save", description = "save", method = "post", tags = "save person service",
